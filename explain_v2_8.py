#!/usr/bin/env python
"""
explain.py — diagnostic CLI for sectioning_v2_8 results.

After running sectioning_v2_8.py on a piece, the output directory will
...
# Add the directory containing sectioning_v2_8.py to sys.path so this
# script can be run from anywhere as long as it's next to the module.
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))

from sectioning_v2_8 import load_result, explain
...
def main():
    ...
    if not os.path.exists(cache_path):
        ...
        print(f"Run sectioning_v2_8.py first to produce it.")
        sys.exit(1)
