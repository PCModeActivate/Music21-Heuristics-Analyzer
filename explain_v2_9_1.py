#!/usr/bin/env python
"""
explain.py — diagnostic CLI for sectioning_v2_9_1 results.

After running sectioning_v2_9_1.py on a piece, the output directory will
...
Example:
    python explain.py ./out_v291 0 7 1.0
...
# Add the directory containing sectioning_v2_9_1.py to sys.path so this
# script can be run from anywhere as long as it's next to the module.
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))

from sectioning_v2_9_1 import load_result, explain
...
def main():
    ...
    if not os.path.exists(cache_path):
        ...
        print(f"Run sectioning_v2_9_1.py first to produce it.")
        sys.exit(1)
